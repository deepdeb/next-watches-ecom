    ...
    <div className='min-h-[70vh] md:min-h-[60vh] lg:min-h-[90vh] flex flex-col md:flex-row justify-center items-center bg-white px-4 md:px-12'>
        <div className='max-w-2xl'>
            ...
            <p className='text-[#495057] mt-4'>
                Discover our curated collection of premium watches, crafted for those who appreciate sophistication and precision.
            </p>
        ...
        <div>
            <Image src="/blue-watch.png" alt='img' width={400} height={400}/>
        </div>
    </div>
  )
}
